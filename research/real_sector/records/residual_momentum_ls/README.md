...
## 一句话思路
[行业均衡] 残差动量多空：对每个资产用尾部窗口把它对「等权市场收益」做过原点回归得到 beta，残差 = 自身收益 - beta×市场收益，按 score_window 期累计残差（以残差波动标准化）截面排序，做多残差动量最强的 top 分位、做空最弱的 bottom 分位，两腿等权各占 0.5 预算，组合美元中性。
