...
## 一句话思路
[行业均衡] PCA/EOF 统计套利：对截面收益的滚动协方差做 numpy.linalg.eigh 特征分解，取前 m 个主成分构造投影矩阵 P 重构「公允（系统性）收益」，特质残差 u = r - P·r 在 h 日上累计成实际价格相对公允价格的偏离，按自身残差波动标准化后做多被低估(z 低)、做空被高估(z 高)的资产，逐行去均值后为美元中性组合。
