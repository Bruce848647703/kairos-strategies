...
## 一句话思路
[行业均衡] 海龟 + ATR 仓位：唐奇安通道突破入场(收盘创 N 日新高做多、跌破 M 日新低离场，通道 shift(1) 防未来，状态机持有)，每资产仓位 = 等预算(1/N) × 持有(0/1) × min(risk_target/(ATR/价格), 1)，即按 ATR 占价比反比缩放——波动大仓位小、波动小仓位大，单资产上限=1/N，逐行和≤1。
